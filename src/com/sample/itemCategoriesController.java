...
public class itemCategoriesController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try (Connection conn = PooledConnection.getConnection()) {
            String query = "SELECT ITEM_CAT_ID, NAME, DESCRIPTION, ARCHIVED_FLAG FROM FMO_ITEM_CATEGORIES";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (Connection conn = PooledConnection.getConnection()) {
            if ("archive".equals(action) && itemCID != null) {
                ...
                String updateSql = "UPDATE FMO_ITEM_CATEGORIES SET NAME = ?, DESCRIPTION = ? WHERE ITEM_CAT_ID = ?";
                ...
                String insertSql = "INSERT INTO FMO_ITEM_CATEGORIES (NAME, DESCRIPTION) VALUES (?, ?)";
