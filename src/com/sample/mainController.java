...
public class mainController extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PreparedStatement stmntFloor = con.prepareCall(
            "SELECT * FROM FMO_ITEM_LOC_FLOORS " +
            "ORDER BY ITEM_LOC_ID, " +
            "         CASE " +
        ...
        PreparedStatement stmntItems = con.prepareCall(
            "SELECT * FROM FMO_ITEMS " +
            ...
            "         ITEM_ID"
             ...
             PreparedStatement stmntMaintSched = con.prepareCall("SELECT * FROM FMO_ITEM_MAINTENANCE_SCHED WHERE ARCHIVED_FLAG = 1 ORDER BY ITEM_MS_ID");
