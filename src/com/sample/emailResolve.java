...
public class emailResolve extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        final String username = "wingfinity.torrecentral@gmail.com";
        final String password = "efsqvsibcmprilsx";
        ...
        try (Connection connection = PooledConnection.getConnection()) {
            ...
            String selectQuery = "SELECT * FROM FMO_ITEM_REPORTS WHERE REPORT_ID = ?";
            ...
            String locationQuery = "SELECT NAME FROM FMO_ITEM_LOCATIONS WHERE ITEM_LOC_ID = ?";
            ...
            String updateQuery = "UPDATE FMO_ITEM_REPORTS SET STATUS = 1 WHERE REPORT_ID = ?";
