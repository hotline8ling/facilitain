...
public class FeedbackClientController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String locationQuery = "SELECT ITEM_LOC_ID, NAME FROM FMO_ITEM_LOCATIONS WHERE ACTIVE_FLAG != 2";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String insertFeedbackQuery = "INSERT INTO FMO_ITEM_FEEDBACK (FEEDBACK_ID, ITEM_LOC_ID, ROOM, RATING, SUGGESTIONS, REC_INS_DT, REC_INS_BY) " +
                                     "VALUES (?, ?, ?, ?, ?, SYSDATE, USER)"; 
